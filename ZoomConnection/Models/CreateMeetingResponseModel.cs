...
namespace ZoomConnection.Models
{
    public class CreateMeetingResponseModel
    {
        ...
        public CreateMeetingResponseTrackingFields TrackingFields { get; set; }

        [JsonProperty("occurances")]
        public CreateMeetingResponseOccurances Occurances { get; set; }

        [JsonProperty("settings")]
        public CreateMeetingResponseSettings Settings { get; set; }

        [JsonProperty("recurrence")]
        public CreateMeetingResponseRecurrence Recurrence { get; set; }
    }

    public class CreateMeetingResponseTrackingFields
    {
        [JsonProperty("field")]
    ...
    public class CreateMeetingResponseOccurances
    {
    ...
    public class CreateMeetingResponseSettings
    {
        ...
        //enforce_login and enforce_login_domains are deprecated
    ...
    public class CreateMeetingResponseRecurrence
    {
