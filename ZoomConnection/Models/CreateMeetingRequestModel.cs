...
namespace ZoomConnection.Models
{
    public class CreateMeetingRequestModel
    {
        ...
        public CreateMeetingRequestTrackingFields TrackingFields { get; set; }

        [JsonProperty("settings")]
        public CreateMeetingRequestSettings Settings { get; set; }

        [JsonProperty("recurrence")]
        public CreateMeetingRequestRecurrence Recurrence { get; set; }
    }

    public class CreateMeetingRequestTrackingFields
    {
        [JsonProperty("field")]
    ...
    public class CreateMeetingRequestSettings
    {
    ...
    public class CreateMeetingRequestRecurrence
    {
